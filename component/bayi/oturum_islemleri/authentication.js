...
router.post('/login', async function (req, res) {
	...
	if (req.body != "")
	{
		...
		if (!BODY_ICERIK.e_bayi_kodu || BODY_ICERIK.e_bayi_kodu == "")
		{
			res.send([{"S": "H", "HATA_KODU": "803", "HATA_ACIKLAMASI": "İçerik Hatası - e_bayi_kodu Boş Olamaz"}])
			res.end()
			return false
		}  
		...
		SORGU = "SP_W_T_BAYI_KULLANICILARI @islem = 'G', "+
									" @e_bayi_kodu = '" + BODY_ICERIK.e_bayi_kodu + "', "+
...
router.post('/logout', async function (req, res) {
	...
	BODY_ICERIK = ""
		...
		SORGU = "SP_W_T_BAYI_KULLANICILARI @islem = 'C', @TOKEN = '" + req.headers['utoken'] + "'"
...
SWAGGER_BAYI_HAZIRLA.JSON_DAHIL_ET(JSON_loginIslemleri)